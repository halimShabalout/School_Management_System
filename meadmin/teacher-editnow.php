				...
				<form class="form-horizontal" method="post">
					...
					<div class="form-group">
						...
						<select id="selector1" class="form-control1" name="up_gender">
						   <option value="<?php echo $edit_teacher_display['t_gender']; ?>">Cinsiyet seç</option>
							<option>Erkek</option>
						   <option>Kadın</option>
							</select>
					</div>
					...
					<div class="col-sm-offset-2"> <button type="submit" class="btn btn-default" name="up_teacher"> Güncelle</button> </div>
				</form>
			</div>
