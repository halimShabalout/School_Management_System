		...
		<div class="tab-inner">
			<div id="tabs" class="tabs">
				...
				<div class="graph">
					<nav>
						<ul>
							<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-briefcase"></i> <span>kurs Bilgileri</span></a></li>
							<li><a href="#section-2" class="icon-cup"><i class="lnr lnr-lighter"></i> <span>Dönemleri Yönetme</span></a></li>
							...
							<li><a href="#section-5" class="icon-truck"><i class="fa fa-truck"></i> <span>Talep</span></a></li>
						</ul>
					</nav>
