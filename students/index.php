								...
								<!--/login-->
									   ...
									   <div class="error_page">
												<!--/login-top-->
													...
													<div class="error-top">
													<h2 class="inner-tittle page">Öğrenci</h2>
													    <div class="login">
														<h3 class="inner-tittle t-inner">Giriş yap</h3>
																...
																<form method="post">
																		...
																		<div class="new">
																			<p><label class="checkbox11"><input type="checkbox" name="checkbox"><i> </i>Şifre unuttun mu ?</label></p>
										...
										<div class="footer">
												<div class="error-btn">
															<a class="read fourth" href="index.html">Ana sayfaya geri dön</a>
															</div>
