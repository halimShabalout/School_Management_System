...
<html lang="en">
<head>
    <title>SOFTWARE WEB SCHOOL</title>
    <!-- Meta tag Keywords -->
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i>SoftWare</a></h1>

			</div>
			<div class="w3layouts_header_right">
			    <form action="#" method="post">
					<input name="Search here" type="search" placeholder="Ara" required="">
					<input type="submit" value="">
				</form>
			</div>
			<ul class="agile_forms">
				<li><a class="active" href="students/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Giriş Yap</a> </li>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						<li class="active"><a href="index.html" class="effect-3">Main</a></li>
						<li><a href="#about" class="effect-3 scroll">Hakkımızda</a></li>
						<li><a href="#services" class="effect-3 scroll">Hizmetler</a></li>
						<li><a href="#gallery" class="effect-3 scroll">Bölümler</a></li>
						<li><a href="#team" class="effect-3 scroll">Ekip</a></li>
						<li><a href="#mail" class="effect-3 scroll">iletişim</a></li>
					</ul>
				</nav>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="NwNZSTHvOKk" id="video"> <img src="./images/ben2.jpg" alt="" class="img-responsive" /> </div>
		</div>
				...
				<form action="#" method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="text">Baba Adı  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="name" type="text" required=""></li>
							<li class="text">Cinsiyet  :  </li>
